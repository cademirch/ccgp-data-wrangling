...
def get_read(wc):
    if Path("downloads", wc.name, (wc.sample + "fastq.gz")).exists():
        return Path("downloads", wc.name, (wc.sample + "fastq.gz"))
    elif Path("downloads", wc.name, (wc.sample + "fq.gz")).exists():
        return Path("downloads", wc.name, (wc.sample + "fq.gz"))
